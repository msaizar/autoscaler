...
// Source: docker.io/go-docker (interfaces: APIClient)
...
import (
	...
	filters "docker.io/go-docker/api/types/filters"
	image "docker.io/go-docker/api/types/image"
	network "docker.io/go-docker/api/types/network"
	registry "docker.io/go-docker/api/types/registry"
